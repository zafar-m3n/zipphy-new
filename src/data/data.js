...
export const botAccounts = [
  {
    ...
    type: "bot",
    features: [
      "Access to AI-powered automated trading with trial bot",
      "Trading leverage: 1:25",
      "Maximum Functional Days: 14 days",
